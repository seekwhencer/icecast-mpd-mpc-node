...
module.exports = function (args) {
    ...
    this.channel = global.station.channels.data[that.options.source_channel];
    this.icecast_config = global.station.icecast.options.config;
    this.source_host = 'http://' + that.icecast_config.hostname + ':' + that.icecast_config['listen-socket'].port;
    this.source = {
